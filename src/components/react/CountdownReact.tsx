...
const CountdownReact = () => {
  const targetDate = new Date('2024-05-11T12:00:00');
  ...
  return (
    <div className="mt-4 flex justify-around items-center">
      {units.map((unit, index) => (
        <div key={index} className="h-20 flex flex-col justify-around items-center">
          <span className="text-3xl countdown-item">{unit.value}</span>
